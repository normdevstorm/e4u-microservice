...
public class ExerciseTemplateController {
        ...
        public ResponseEntity<BaseResponse<List<ExerciseTemplateResponse>>> getByLesson(
                ...
                List<ExerciseTemplateResponse> result = exerciseTemplateService.getExercisesForLesson(lessonTemplateId,
                                userId);
                return ResponseEntity.ok(BaseResponse.ok(result));
        }
        ...
        public ResponseEntity<BaseResponse<List<ExerciseTemplateResponse>>> getByType(
                ...
                List<ExerciseTemplateResponse> result = exerciseTemplateService.getExercisesByType(lessonTemplateId,
                                exerciseType);
                return ResponseEntity.ok(BaseResponse.ok(result));
        }
        ...
        public ResponseEntity<BaseResponse<ExerciseTemplateResponse>> generateForWord(
                ...
                ExerciseTemplateResponse result = exerciseTemplateService.generateExerciseForWord(wordId, exerciseType,
                                userId);
                return ResponseEntity.status(HttpStatus.CREATED).body(BaseResponse.ok(result));
        }
        ...
        public ResponseEntity<BaseResponse<List<ExerciseTemplateResponse>>> generateReviewExercises(
                ...
                List<ExerciseTemplateResponse> result = exerciseTemplateService.generateReviewExercises(userId,
                                lessonTemplateId, wordIds);
                return ResponseEntity.status(HttpStatus.CREATED).body(BaseResponse.ok(result));
        }
