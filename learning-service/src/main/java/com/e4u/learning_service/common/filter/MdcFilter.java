package com.e4u.learning_service.common.filter;

import com.e4u.learning_service.common.logging.MdcConstants;
...
public class MdcFilter extends OncePerRequestFilter {
    ...
    private void setupMdc(HttpServletRequest request, HttpServletResponse response) {
        ...
        // Set service context
        MDC.put(MdcConstants.SERVICE_NAME, "learning-service");
