...
import com.e4u.curriculum_service.client.dto.UserResponse;
...
public class UserServiceClientFallback implements UserServiceClient {
    ...
    public UserResponse getUserById(UUID userId) {
        log.warn("Fallback: Unable to fetch user {}. User service may be unavailable.", userId);
    ...
    public Boolean userExists(UUID userId) {
        log.warn("Fallback: Unable to verify user {}. Assuming user exists.", userId);
